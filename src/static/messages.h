...
#define MSG_SHOOTING_REPORT "%d rounds executed: %d effective shots, dealing %d total damage\n"
#define MSG_VESSELS_COLLISION "__Vessels Collision__\n"
#define MSG_HULL_DMG_REPORT "%s lost %d hull points, dropping from %d down to %d\n"
#define MSG_VESSELS_BOARDING_FIGHT "__Crew Fight__\n"
#define MSG_CREW_SUFFER_REPORT "%s lost %d crew members, dropping from %d down to %d\n"
